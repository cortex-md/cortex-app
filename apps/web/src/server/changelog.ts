...
const GITHUB_RELEASES_URL = "https://api.github.com/repos/cortex-md/cortex-app/releases?per_page=20"
...
export async function mapGithubRelease(release: GithubRelease): Promise<ChangelogRelease | null> {
	...
	return {
		...
		version,
		title,
		url: release.html_url ?? `https://github.com/cortex-md/cortex-app/releases/tag/${tagName}`,
		publishedAt,
