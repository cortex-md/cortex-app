...
description: Create a minimal Cortex theme with a manifest, light.css, dark.css, and vault install location.
...
<DocGrid>
  <DocCard href="/docs/themes/css-variables" title="CSS Variables" description="Choose the semantic variables that shape the app surface." />
  <DocCard href="/docs/themes/light-dark-and-system" title="Light, Dark, and System Modes" description="Understand how Cortex chooses the active CSS file." />
</DocGrid>
