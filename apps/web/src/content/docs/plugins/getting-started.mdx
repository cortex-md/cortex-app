...
description: Create a small command plugin, build it, and load it from a local Cortex vault.
...
<DocGrid>
  <DocCard href="/docs/developers/cli" title="Cortex CLI" description="Install the CLI and run plugin or theme projects against a local vault." />
  <DocCard href="/docs/plugins/manifest-and-capabilities" title="Manifest and Capabilities" description="Understand the manifest fields and permission model before expanding the plugin." />
</DocGrid>
