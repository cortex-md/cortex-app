---
title: "Example: GitHub Emoji Plugin"
description: Study a practical plugin that registers Markdown inline replacements, commands, settings, and a portable view.
...
<DocGrid>
  <DocCard href="/docs/plugins/markdown-and-properties" title="Markdown and Properties" description="Understand the Markdown extension surfaces used by this plugin." />
  <DocCard href="/docs/plugins/views-settings-and-ui" title="Views, Settings, and UI" description="See how portable views, settings, and status surfaces fit together." />
</DocGrid>
